$(document).ready(function() {
    ...
    // el 1er listado por defecto
  	var tabla=  $('#tblListar_incidencias').DataTable({
        ...
        ajax : {
			method: "POST",  			
            url : BASE_URL + "incidencias/listar_incidencias_general" ,            	
        ...
        columns: [
	           ...
	           { "data" : "inc_causa_inmediata_incidente" , render: function(data, row, tipy) {            	
	             ...
	             { "data" : null  , render: function(data, tipy , row) {            	
	            	if (row.inc_estado == 1 ) { 
	            	     
	            	     //para las pendientes sin revisar
	            	     if (row.inc_estado_guardada == 0 ) {
	            	     	return 'Pendiente <br>(Sin revisar)';
	            	     }
	            	...
	            	else if (row.inc_estado == 2) {
		            	return 'Aprobado' ;
		            } 	          
		            else if (row.inc_estado == 3){
		            	return 'Rechazado' ;
		            	}  
		            else {
		            	return 'Sin asignar' ;
	            ...
	            { "data" : "inc_id" , render: function(data, row, tipy) {            				
	            	...
	            	return '<a href="' + BASE_URL +'incidencias/revisar_incidente/' + data + '"  title="Ver">' +
