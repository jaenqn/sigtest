	     ...
	     <div class="form-group">
	        ...
	        <fieldset>
	        	<legend>Revisado  por </legend>		           
		              <input type="input" class="form-control" name="revisador_firma" style="width: 100%; height: 40px"  readonly="">&nbsp;&nbsp;        	
	       	</fieldset> 
	       	 </div> 		
	      </div>
	      <div class="clearfix"></div>
	       <div class="form-group">
	        ...
	        <fieldset>
	        	<legend>Aprobado USEG / UDES </legend>		           
		              <input type="input" class="form-control" name="aprobador_firma" style="width: 100%; height: 40px"  readonly="" >&nbsp;&nbsp;        	
	       	</fieldset> 
	       	 </div> 		
	      </div>
