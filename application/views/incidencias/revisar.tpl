...
<form id="formulario_reporte" action="../aprobar_rechazar_incidente" method="post">
<div class="col-md-12 col-sm-12 col-xs-12">
    ...
    <input type="hidden" name="id_unidad_receptora" value="{$id_unidad_receptora}" />	 
    <!-- estados 1 : Pendiente -->
    <!-- estados 2 : Aprobado -->
    <!-- estados 3 : Rechazado -->
	</div><br>
	     ...
	     <div class="form-group">
	        ...
	        <fieldset>
	        	<legend>Revisado  por </legend>		           
		            <h5>{$item['inc_revisador_firma']}</h5>          	
	       	</fieldset> 
	       	 </div> 		
	      </div>
	      <div class="clearfix"></div>
...
<br><br>
	...
	<div class="col-md-4 col-sm-4 col-xs-12 center-margin text-center" >
		 <button type="submit" class="btn btn-danger" name="rechazar_btn" id="btn_rechazar">Rechazar Incidente</button>
	     <button type="submit" class="btn btn-success" name="aprobar_btn" id="btn_aprobar">Aprobar Incidente</button>	     
	</div>
	{/if} 
