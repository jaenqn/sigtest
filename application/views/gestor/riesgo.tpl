                    ...
                    <form id="frmFiltrar" data-parsley-validate class="form-horizontal form-label-left">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label class="control-label-left col-md-3 col-sm-3 col-xs-12" for="txtNombreRiesgoF"><span>Riesgo</span></label>
                                <div class="col-md-9 col-sm-9 col-xs-12">
                                    <input type="text" id="txtNombreRiesgoF" name="txtNombreRiesgoF" required="required" class="form-control col-md-7 col-xs-12 input-filter">
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            ...
                            <div class="form-group">
                                <label class="control-label-left col-md-3 col-sm-3 col-xs-12" for="selPeligroF">Peligro</label>
                                <div class="col-md-9 col-sm-9 col-xs-12">
                                  <select class="select-default form-control input-filter" tabindex="-1" name="selPeligroF" id="selPeligroF" data-placeholder=" - Seleccione - ">
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="form-group">
                                <label class="control-label-left col-md-3 col-sm-3 col-xs-12" for="selEstadoRiesgoF">Estado</label>
                                <div class="col-md-9 col-sm-9 col-xs-12">
                                  <select class="select-minimum form-control input-filter" tabindex="-1" name="selEstadoRiesgoF" id="selEstadoRiesgoF" data-placeholder=" - Seleccione - ">
                                    <option></option>
            ...
            <div class="x_panel">
              <div class="x_title">
                ...
                <ul class="nav navbar-right panel_toolbox">
                  <li><a  class="btn btn-primary" id="btnNuevo" style="float:right"  title="Agregar nuevo riesgo" >Nuevo Riesgo</a></li>
                </ul>
                <div class="clearfix"></div>
              </div>
              <div class="x_content">
...
{block 'script'}
  ...
  <script src="{$public_url}vendors/datatables.net/js/jquery.dataTables.min.js"></script>
    ...
    <script src="{$public_url}views/gestor/js/riesgo.js" async="async"></script>
{/block}