...
{block 'contenido'}
    ...
    <div class="row">
              <div class="col-md-10 col-sm-10 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Gestionar Peligros <small>&nbsp;</small></h2>
                    ...
                    <form id="frmFiltrar" data-parsley-validate class="form-horizontal form-label-left">
                          ...
                          <div class="col-sm-6">
                            ...
                            <div class="form-group">
                                <label class="control-label-left col-md-3 col-sm-3 col-xs-12" for="txtNombrePeligroF"><span>Peligro</span></label>
                                <div class="col-md-9 col-sm-9 col-xs-12">
                                    <input type="text" id="txtNombrePeligroF" name="txtNombrePeligroF" required="required" class="form-control col-md-7 col-xs-12 input-filter">
                                </div>
                            </div>
                          </div>
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label class="control-label-left col-md-3 col-sm-3 col-xs-12" for="selTipoCategoriaF">Categoría</label>
                                <div class="col-md-9 col-sm-9 col-xs-12">
                                  <select class="select-minimum form-control input-filter" tabindex="-1" name="selTipoCategoriaF" id="selTipoCategoriaF" data-placeholder=" - Seleccione - ">
                                    ...
                                    {foreach $lstCategoriasPeligro as $obj}
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label class="control-label-left col-md-3 col-sm-3 col-xs-12" for="selEstadoPeligroF">Estado</label>
                                <div class="col-md-9 col-sm-9 col-xs-12">
                                  <select class="select-minimum form-control input-filter" tabindex="-1" name="selEstadoPeligroF" id="selEstadoPeligroF" data-placeholder=" - Seleccione - ">
                                    <option></option>
...
<div class="row">
  <div class="col-md-10 col-sm-10 col-xs-12">
    <div class="x_panel">
      <div class="x_title">
        <h2>Lista de  Peligros <small>&nbsp;</small></h2>

        <ul class="nav navbar-right panel_toolbox">
          <li><a  class="btn btn-primary" id="btnNuevo" style="float:right"  title="Agregar nuevo peligro" >Nuevo Peligro</a></li>
        </ul>
        <div class="clearfix"></div>
      </div>
      <div class="x_content">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
              ...
              <h4 class="modal-title" id="tituloModal">Agregar Peligro</h4>
            </div>
            <div class="modal-body">
              <!-- ##FRM REGISTRO-->
                    ...
                    <div class="form-group">
                        <label class="control-label-left col-md-3 col-sm-3 col-xs-12" for="txtNombrePeligro">Peligro
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <input type="text" id="txtNombrePeligro" data-validate-words="2" name="txtNombrePeligro" required="required" class="form-control col-md-7 col-xs-12">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <label class="control-label-left col-md-3 col-sm-3 col-xs-12" for="chkEstadoPeligro">Estado </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <input type="checkbox" class="radio-flat flat" name="chkEstadoPeligro" id="chkEstadoPeligro"   checked="" />
                             Activo
                        </div>
                    </div>
...
{block 'script'}
  ...
  <script src="{$public_url}vendors/datatables.net/js/jquery.dataTables.min.js"></script>
    ...
    <script src="{$public_url}views/gestor/js/peligros.js" async="async"></script>
{/block}