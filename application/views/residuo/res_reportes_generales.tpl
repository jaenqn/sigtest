...
{block 'css'}
    ...
    <style type="text/css">
      #tblGenResSol.table>tbody>tr>td, .table>tbody>tr>th, .table>tfoot>tr>td, .table>tfoot>tr>th, .table>thead>tr>td, .table>thead>tr>th{
        padding: 2px;
      }
    </style>
{/block}
              ...
              <div class="col-md-10 col-sm-10 col-xs-12">
                  ...
                  <div class="x_content">
                    <form id="frmFiltrar" data-parsley-validate class="form-horizontal form-label-left">
                      <div class="form-group">
                        <label for="selYear" class="control-label-left col-md-2 col-sm-2 col-xs-12">Seleccione Año</label>
                        <div class="col-md-3 col-sm-3 col-xs-12">
                         ...
                         <div class="col-sm-6">
                                ...
                                <div class="col-md-6 col-sm-3 col-xs-12 ">
                                  ...
                                  <a   class="btn btn-success" id="btnGenerar" disabled="">Generar Excel</a>
                                </div>
                              </div>
                            </div>
                      </div>
                {*       <div class="form-group">
                    ...
                    <fieldset>
                      ...
                      <div class="col-sm-12 ">
                        <table class="table table-bordered table-hover" style="" id="tblGenResSol">
                        <thead>
                       {*    <tr>
                        ...
                        <tbody>
                          <tr class="containermes" data-res-mes="1">
                            <th class="app-text-center" style="" ><div>Enero</div></th>
                            <td class="app-text-center res-np-organico">&nbsp;--&nbsp;</td>
                            <td class="app-text-center res-np-inorganico">&nbsp;--&nbsp;</td>
                            <td class="app-text-center res-np-total">&nbsp;--&nbsp;</td>
                            <td class="app-text-center res-p-total">&nbsp;--&nbsp;</td>
                            <td class="app-text-center res-total">&nbsp;--&nbsp;</td>

                          </tr>
                          <tr class="containermes" data-res-mes="2">
                          ...
                          <tr class="containermes" data-res-mes="3">
                          ...
                          <tr class="containermes" data-res-mes="4">
                          ...
                          <tr class="containermes" data-res-mes="5">
                          ...
                          <tr class="containermes" data-res-mes="6">
                          ...
                          <tr class="containermes" data-res-mes="7">
                          ...
                          <tr class="containermes" data-res-mes="8">
                          ...
                          <tr class="containermes" data-res-mes="9">
                          ...
                          <tr class="containermes" data-res-mes="10">
                          ...
                          <tr class="containermes" data-res-mes="11">
                          ...
                          <tr class="containermes" data-res-mes="12">
                          ...
                          <tr class="containertotal">
                            <th class="app-text-center " style=""><div>Total</div></th>
                            <td class="app-text-center total-np-org">&nbsp;--&nbsp;</td>
                            <td class="app-text-center total-np-ino">&nbsp;--&nbsp;</td>
                            <td class="app-text-center total-np">&nbsp;--&nbsp;</td>
                            <td class="app-text-center total-pel">&nbsp;--&nbsp;</td>
                            <td class="app-text-center total-res">&nbsp;--&nbsp;</td>
                          </tr>
                          <tr class="containerpro">
                            <th class="app-text-center " style=""><div>Promedio</div></th>
                            <td class="app-text-center pro-np-org">&nbsp;--&nbsp;</td>
                            <td class="app-text-center pro-np-ino">&nbsp;--&nbsp;</td>
                            <td class="app-text-center pro-np">&nbsp;--&nbsp;</td>
                            <td class="app-text-center pro-pel">&nbsp;--&nbsp;</td>
                            <td class="app-text-center pro-res">&nbsp;--&nbsp;</td>
                          </tr>
...
{block 'script'}
  ...
  <script src="{$public_url}vendors/datatables.net/js/jquery.dataTables.min.js"></script>
    ...
    <script src="{$public_url}views/residuo/js/res_reportes_generales.js" async="async"></script>
    <script>
