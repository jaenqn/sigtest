...
<div class="row">	
	<div class="col-md-12 col-sm-12 col-xs-12 center-margin">
	 ...
	 <form   method="POST" action="../editar_indicador_general" >
	 	<input type="hidden"  name="id_indicador" value="{$item['ind_id']}"/>		 
	    <div class="form-group">
            <label class="control-label col-md-2 col-sm-2 col-xs-12">Indicador de Desempeño</label>
            <div class="col-md-8 col-sm-8 col-xs-12">
              <input type="text" class="form-control" name="indicador"  placeholder="" required value="{$item['ind_indicador']}"> 
            </div>
        </div> <br><br><br>	 
      ...
      <div class="form-group">
            ...
            <div class="col-md-4 col-sm-4 col-xs-12">
              <input type="text" class="form-control" name="formula"  placeholder="" required value="{$item['ind_formula']}"> 
            </div>
        </div> <br><br><br>	
        ...
        <div class="form-group">
            ...
            <div class="col-md-4 col-sm-4 col-xs-12">
              <input type="text" class="form-control" name="nivel"  placeholder="" required value="{$item['ind_nivel']}"> 
            </div>
        </div> <br><br><br>	 
