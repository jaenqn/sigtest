            ...
            <div class="x_content">
              <div class="" role="tabpanel" data-example-id="togglable-tabs">
                <ul id="myTab1" class="nav nav-tabs bar_tabs left" role="tablist">
                  <li role="presentation" class="active"><a href="#tab_content11" id="home-tabb" role="tab" data-toggle="tab" aria-controls="home" aria-expanded="true">Detalles de Boleta</a>
                  </li>
                  {if ent_boleta::inEstado($objBoleta->bol_estado, array('respondido','seguimiento','seguimiento_fin'))}
                  ...
                  {/if}
                  {if ent_boleta::inEstado($objBoleta->bol_estado, array('respondido', 'seguimiento','seguimiento_fin')) && $objBoleta->bol_plazo_establecido == 1}
                  ...
                  {/if}
                  {if ent_boleta::inEstado($objBoleta->bol_estado, array('respondido')) && $objBoleta->bol_plazo_establecido == 0 && ent_usuarios::permitir(AppSession::get('tipo_usuario'), array('administrador'))}
                    <li role="presentation" class=""><a href="#tab_content33" role="tab" id="profile-tabb3" data-toggle="tab" aria-controls="profile" aria-expanded="false">Fiscalizar Boleta</a>
                    </li>
                  {/if}
                </ul>
