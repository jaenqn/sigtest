                  ...
                  <fieldset>
                    ...
                    <table class="table table-bordered table-hover" id="tblFicheros">
                      ...
                      {foreach $objBoleta->ficheros_evidencia as $files}
                        <tr>
                            <td style="width: 40px" class="icon-files"><img src="{$base_url}public/app/img/iconos/{$files->ico_img[1]}" title="{$files->ico_img[2]}"></img></td>
...
<!-- bootstrap-daterangepicker -->
    ...
    <script src="{$public_url}views/boletasig/js/bol_procesar.js"></script>
