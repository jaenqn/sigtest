...
class Customers_model extends CI_Model {
    ...
    // var $table = 'customers';
    var $table = 'empresa_contratista';
    // var $column_order = array(null,'empc_id',
    // 'empc_nombre',
    // 'empc_direccion',
    // 'empc_telefono',
    // 'empc_fecha_registro');

    // var $column_search = array('empc_id',
    // 'empc_nombre',
    // 'empc_direccion',
    // 'empc_telefono',
    // 'empc_fecha_registro',);
    ...
    var $order = array('empc_id' => 'asc'); // default order
    ...
    function get_datatables()
    {
        ...
        $query = $this->db->get();
        return $query->custom_result_object('EmpresaContratista');
        // return $query->result();
    }
